 ...
 * 
 */
UCLASS(DisplayName = "Extended Game Instance")
...
#pragma region Arbitrary
	...
	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category = "Extended Game Instance")
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Extended Game Instance")
	...
	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "Extended Game Instance|Event Dispatcher")
